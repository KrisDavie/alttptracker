...
export const allPresets: LauncherPreset[] = [
  ...
  // ── All Dungeons ────────────────────────────────────────────────────────
  {
    ...
    settings: { goal: "ganon", ganonVulnerable: "ad" },
  },
  {
    id: "adenemizer",
    name: "AD Enemizer",
    description: "All Dungeons with boss and enemy shuffle",
    settings: { goal: "ganon", ganonVulnerable: "ad", bossShuffle: "random", enemyShuffle: "random" },
  },
  {
    id: "adkdb",
    name: "ADKDB",
    description: "All Dungeons, keysanity, key drop, start with boots",
    settings: { goal: "ganon", ganonVulnerable: "ad", enemyDrop: "keys", pottery: "keys", wildSmallKeys: "wild", wildBigKeys: true, wildMaps: true, wildCompasses: true },
    startingItems: { boots: 1 },
  },
  {
    id: "adkdf",
    ...
    entrancePlacements: {
      ...
      "Elder House (West)": "Desert Palace Entrance (South)",
  ...
  },
  {
    ...
    settings: { goal: "ganon", ganonVulnerable: "ad", pottery: "keys", wildSmallKeys: "wild", wildBigKeys: true, wildMaps: true, wildCompasses: true, shopsanity: true },
  },
  {
    id: "adkeysanity",
    name: "AD Keysanity",
    description: "All Dungeons with full keysanity",
    settings: { goal: "ganon", ganonVulnerable: "ad", wildSmallKeys: "wild", wildBigKeys: true, wildMaps: true, wildCompasses: true },
  },
  {
    id: "adtileswap",
    name: "AD Tile Swap",
    description: "All Dungeons with overworld tile swap",
    settings: { goal: "ganon", ganonVulnerable: "ad", owMixed: true },
  },
  ...
  },
  {
    ...
    settings: { goal: "ganon", ganonVulnerable: "ad", entranceMode: "crossed", pottery: "keys", enemyDrop: "keys", wildSmallKeys: "wild", wildBigKeys: true, wildMaps: true, wildCompasses: true },
  },
  {
    id: "supercrosskeys",
    name: "Supercrosskeys",
  ...
  },
  {
    ...
    settings: { worldState: "standard", goal: "ganon", ganonVulnerable: "ad", swords: "assured", wildSmallKeys: "wild", wildBigKeys: true, wildMaps: true, wildCompasses: true },
    startingItems: { boots: 1 },
  },
  {
    id: "cabookeydrop",
    ...
    settings: { worldState: "standard", goal: "ganon", ganonVulnerable: "ad", swords: "assured", pottery: "keys", enemyDrop: "keys", wildSmallKeys: "wild", wildBigKeys: true, wildMaps: true, wildCompasses: true },
    startingItems: { boots: 1 },
  },
  {
    id: "hardopenplus",
  ...
  },
  {
    ...
    settings: { goal: "ganon", ganonVulnerable: "ad", wildCompasses: true },
  },
  {
    id: "mystery",
    name: "Mystery",
  ...
  },
  {
    ...
    settings: { goal: "ganon", ganonVulnerable: "ad", bossShuffle: "random", wildSmallKeys: "wild", wildBigKeys: true, activatedFlute: true },
