...
export type AddressSpace = (typeof AddressSpace)[keyof typeof AddressSpace] & number;
/**
...
export type MemoryMapping = (typeof MemoryMapping)[keyof typeof MemoryMapping] & number;
/**
...
export type DeviceCapability = (typeof DeviceCapability)[keyof typeof DeviceCapability] & number;
/**
...
export type Field = (typeof Field)[keyof typeof Field] & number;
/**
 * @generated from protobuf enum DirEntryType
 */
export const DirEntryType = {
...
export type DirEntryType = (typeof DirEntryType)[keyof typeof DirEntryType] & number;
                ...
                case /* repeated DeviceCapability capabilities */ 4: {
                    ...
                    if (wireType === WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
                            message.capabilities.push(reader.int32() as DeviceCapability);
                    else
                        message.capabilities.push(reader.int32() as DeviceCapability);
                    break;
                                }case /* AddressSpace defaultAddressSpace */ 5: 
                    message.defaultAddressSpace = reader.int32() as AddressSpace;
                    break;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional MemoryMapping fallbackMemoryMapping */ 2: 
                    message.fallbackMemoryMapping = reader.int32() as MemoryMapping;
                    break;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* MemoryMapping memoryMapping */ 2: 
                    message.memoryMapping = reader.int32() as MemoryMapping;
                    break;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* AddressSpace requestAddressSpace */ 2: 
                    message.requestAddressSpace = reader.int32() as AddressSpace;
                    break;
                case /* MemoryMapping requestMemoryMapping */ 4: 
                    message.requestMemoryMapping = reader.int32() as MemoryMapping;
                    break;
                case /* uint32 size */ 3: 
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* AddressSpace deviceAddressSpace */ 4: 
                    message.deviceAddressSpace = reader.int32() as AddressSpace;
                    break;
                case /* bytes data */ 5: 
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* DirEntryType type */ 2: 
                    message.type = reader.int32() as DirEntryType;
                    break;
                default: {
                    const u = options.readUnknownField;
                    if (u === "throw")
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated Field fields */ 2: {
                    ...
                    if (wireType === WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
                            message.fields.push(reader.int32() as Field);
                    else
                        message.fields.push(reader.int32() as Field);
                    break;
                                }default: {
...
class NWACommandResponse_NWAASCIIItem$Type extends MessageType<NWACommandResponse_NWAASCIIItem> {
    ...
    private binaryReadMap1(map: NWACommandResponse_NWAASCIIItem["item"], reader: IBinaryReader, _options: BinaryReadOptions): void {
        void _options;
        let key: keyof NWACommandResponse_NWAASCIIItem["item"] | undefined, val: string | undefined;
        const len = reader.uint32(), end = reader.pos + len;
        while (reader.pos < end) {
