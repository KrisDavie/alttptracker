...
function EntranceSelectionModal() {
  ...
  return (
    <div className={`absolute inset-x-8 ${["compact"].includes(mapMode) ? "inset-y-2" : "inset-y-6"} bg-gray-900/95 border-2 border-gray-600 rounded-lg flex flex-col items-center text-white p-4 z-50 shadow-2xl overflow-hidden pointer-events-auto max-h-max`}>
      ...
      <div className={`grid ${["vertical", "compact"].includes(mapMode) ? "gap-2" : "grid-cols-[5fr_4fr_5fr] gap-4"} w-full`}>
        {/* LW */}
        ...
        <div className="flex flex-col gap-4 w-full">
          <div className="flex flex-col gap-1 w-full">
            ...
            <div className="grid grid-cols-4 gap-1 w-full">
              {getEntranceButton("Generic Item Cave")}
            </div>
          </div>
          <div className="flex flex-col gap-1 w-full">
